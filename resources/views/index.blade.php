                        ...
                        <div class="row h-100 align-items-center">
                            <div class="col-12">
                                <div class="welcome_slide_text">
                                    <h6 data-animation="bounceInDown" data-delay="0" data-duration="500ms">* Currently we offer Embroidery</h6>
                                    <h2 data-animation="fadeInUp" data-delay="500ms" data-duration="500ms">Embroidery Trends</h2>
                ...
                <div class="single_slide height-800 bg-img background-overlay" style="background-image: url(img/bg-img/bg-4.jpg);">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            <div class="col-12">
                                <div class="welcome_slide_text">
                                    <h6 data-animation="fadeInDown" data-delay="0" data-duration="500ms">* Currently we offer School and Offices Design</h6>
                                    <h2 data-animation="fadeInUp" data-delay="500ms" data-duration="500ms">Design Collection</h2>
                ...
                <div class="single_slide height-800 bg-img background-overlay" style="background-image: url(img/bg-img/bg-2.jpg);">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            <div class="col-12">
                                <div class="welcome_slide_text">
                                    <h6 data-animation="fadeInDown" data-delay="0" data-duration="500ms">* Currently we offer Tailoring</h6>
                                    <h2 data-animation="bounceInDown" data-delay="500ms" data-duration="500ms">Tailoring Fashion</h2>
        ...
        <section class="new_arrivals_area section_padding_100_0 clearfix">
            ...
            <div class="karl-projects-menu mb-100">
                <div class="text-center portfolio-menu">
                    ...
                    <button class="btn" data-filter=".man">MEN</button>
                    <button class="btn" data-filter=".access">KID</button>
                    <button class="btn" data-filter=".shoes">COOPERATES</button>
                    <button class="btn" data-filter=".kids">HOME</button>
                </div>
            </div>
                ...
                <div class="row karl-new-arrivals">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 single_gallery_item women wow fadeInUpBig" data-wow-delay="0.2s">
                        ...
                        <div class="product-img">
                            <img src={{ asset("img/upload/".$image->image_name)}} alt="">
