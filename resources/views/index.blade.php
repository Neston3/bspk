...
<div class="highlight-clean">
    <div class="logo-div"><img src="{{ asset('img/logo.jpg') }}" class="brand-logo"></div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center features">
            <div class="col-sm-6 col-md-5 col-lg-4 item">
                <div class="box"><img src="{{ asset('img/Badge-03.jpg') }}" id="icon-service">
                    ...
                    <a href="{{ asset('embroidering') }}" class="learn-more">Learn more »</a></div>
            </div>
            <div class="col-sm-6 col-md-5 col-lg-4 item">
                <div class="box"><img src="{{ asset('img/Badge-05.jpg') }}" id="icon-service-sale">
                    ...
                    <a href="{{ asset('fabric') }}" class="learn-more">Learn more »</a></div>
            </div>
            <div class="col-sm-6 col-md-5 col-lg-4 item">
                <div class="box"><img src="{{ asset('img/Badges-02.jpg') }}" id="icon-service-design">
                    ...
                    <a href="{{ asset('office') }}" class="learn-more">Learn more »</a></div>
            </div>
            <div class="col-sm-6 col-md-5 col-lg-4 item">
                <div class="box"><img src="{{ asset('img/Badge-04.jpg') }}" id="icon-service">
                    ...
                    <a href="{{ asset('tailoring') }}" class="learn-more">Learn more »</a></div>
            </div>
        </div>
    </div>
</div>
...
<div id="email-subscribe" class="newsletter-subscribe">
    <div class="container">
        ...
        <form class="form-inline" method="post" action="{{ asset('/subscribe/submit') }}">
            {{csrf_field()}}
